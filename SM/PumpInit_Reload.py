...
TT = np.array([[( 0, 'action0_0')  ,(0, 'action0_1') ,(0, 'action0_2') ,(1, 'action0_3') ,(12,'action0_4') ,(13, 'action0_5'), (0, 'None')     , (0, 'None')      , (0, 'None')      , (0, 'None')      , (0, 'None')       , (0, 'None')        , (0, 'None')        , (0, 'None')         ],  #<---STATE0
               ...
               [( 5, 'action5_0')  ,(5, 'action5_1') ,(6, 'action5_2') ,(12,'action5_3') ,(13,'action5_4') ,(0, 'None')      , (0,'None')      , (0, 'None')      , (0, 'None')      , (0, 'None')      , (0, 'None')       , (0, 'None')        , (0, 'None')        , (0, 'None')         ],  #<---STATE5
...
def NewAirSlugs(pump_address, valve_address):    
    if pump_address == HW.TIRRANT_PUMP_ADDRESS:
        str1 = "Titrant pump: New Air Slug\nValve 2 = Pump to Line \n"\
            + "Valve 3 = Line to Pump\nValve5 = Reservoirs\nValve9 = Air\n"
        ...
        # GV.VALVE_9 = "Air"
        time.sleep(.5)
        valve_to_air = HW.VALVE9_P2
        valve_to_water = HW.VALVE9_P3
    elif pump_address== HW.SAMPLE_PUMP_ADDRESS:
        str1 = "Sample pump: New Air Slug\nValve 2 = Pump to Line\n"\
            + "Valve 4 = Pump to Line\nValve7 = Reservoirs\nValve8 = Air\n"
        GV.SM_TEXT_TO_DIAPLAY  = str1
    ...
    while (airslug_count < air_slug_total_count):        
        ...
        # Air slug
        time.sleep(1)   
        GV.pump1.set_multiwayvalve(valve_address,valve_to_air)        #Valve to Air
        if pump_address == HW.TIRRANT_PUMP_ADDRESS:
            GV.VALVE_9 =  "Air"
            str2 = "Valve 9 = Air\n"
        else:
        ...
        if pump_address == HW.TIRRANT_PUMP_ADDRESS:
            GV.VALVE_9 =  "DI Water"
            str2 = "Valve 9 to DI Water"
        else:
            GV.VALVE_8 =  "DI Water"
            str2 = "Valve 8 to DI Water"
        GV.SM_TEXT_TO_DIAPLAY  = str1 + str2            
        time.sleep(2)        
...
def action5_0():
    if (GV.PAUSE == True):
        ...
        GV.SM_TEXT_TO_DIAPLAY = "Pump 1 to pickup position\n" "Pump 2 to pickup position"
        GV.next_E = 1
...
def action5_1():
    ...
    while ( pos1 != titrant_pump_fill_position   or   pos2 != sample_pump_fill_position)  :
        ...
        logger.info('\t\tPump 1 pos:{}/{},   Pump2 po:{}/{}'.format(pos1,titrant_pump_fill_position
                                                                    , pos2, sample_pump_fill_position))
        
    logger.info('\t\tPumps in pickup positions')
    if (GV.PAUSE == True):
        GV.next_E = 3
        GV.SM_TEXT_TO_DIAPLAY = "going to Pause state"
        return 
        ...
        GV.SM_TEXT_TO_DIAPLAY ="pump 1 in pickup  position\n""pump 2 to in pickup position"
        GV.next_E = 2
...
def action7_1():
    ...
    timeout = False
    # # Pumps to positions
    # fill_pos_titrant =int( RECIPE['PumpInit_Reload']['titrantpump_syringe_fill_volume'] * GV.PUMP_TITRANT_SCALING_FACTOR )
    # fill_pos_sample =int( RECIPE['PumpInit_Reload']['samplepump_syringe_fill_volume'] * GV.PUMP_SAMPLE_SCALING_FACTOR )
